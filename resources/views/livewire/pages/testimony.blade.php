    ...
    <div class="flex flex-col items-center lg:flex-row">
        <div class="flex flex-col items-start justify-center w-full h-full pr-8 mb-10 lg:mb-0 lg:w-1/2">
            ...
            <p class="mb-4 font-medium text-gray-600">Don't just take our word for it, read from our extensive list
                of case studies and customer testimonials.</p>
            <a href="#_"
                class="py-1.5 px-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-reservio rounded-md hover:bg-reservio-darker">View
                Case Studies</a>
        </div>
            ...
            <blockquote class="flex items-center justify-between w-full col-span-1 p-6 mt-4 bg-white rounded-lg">
                <div class="flex flex-col pr-8">
                    <div class="relative pl-12">
                        ...
                        <p class="mt-2 text-sm text-gray-600 sm:text-base lg:text-sm xl:text-base">Awesome
