<div>
    <!-- component -->
    <div class="pt-2 w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
        <div x-data="{ open: false }"
            ...
            <nav :class="{'flex': open, 'hidden': !open}"
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100"
                        ...
                        <div class="px-2 py-2 bg-white rounded-md shadow dark-mode:bg-gray-800">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button
                                    class="inline-block text-left w-full align-left px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">
                                    Logout
                                </button>
                            </form>
                        </div>
                ...
                <a class="px-4 py-2 mt-2 text-sm font-semibold rounded-lg bg-reservio text-white dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:bg-reservio-darker focus:bg-reservio-darker focus:outline-none focus:shadow-outline"
                    href="#"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 font-bold" fill="none"
