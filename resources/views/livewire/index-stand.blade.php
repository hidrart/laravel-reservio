<div class="item-center">
    <div class="flex grid grid-cols-12 pb-12 sm:px-5 gap-x-8 gap-y-16">
        ...
        <div class="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
            <a href="#" class="block">
                <img class="object-cover w-full mb-2 overflow-hidden rounded-lg max-h-56" src="{{ $stand->cover }}">
            </a>
            <div class="w-full flex justify-between">
                ...
                @for ($i = 0; $i < count($color); $i++) @if ($stand->type == $standCategory[$i])
                    ...
                    <div class="flex items-center text-xs font-medium uppercase">
                        <svg class="h-6 fill-current text-grey-400" xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="text-sm text-gray-500 text-justify">{!! \Illuminate\Support\Str::limit($stand->description,
                150,'...') !!}</p>
            @php
